<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MisAprendices.aspx.cs" Inherits="SistemaPlanMejoramiento.MisAprendices" %>
...
<head runat="server">
    ...
    <title>Mis Aprendices - SENA</title>
...
<form id="form1" runat="server">
    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="MisAprendices.aspx" class="nav-link active"><i class="fa-solid fa-user-graduate"></i> Mis Aprendices</a>
    ...
    <div class="main">
        <div class="topbar">
            <div class="topbar-left">
                ...
                <div>
                    <div class="page-title">Mis Aprendices</div>
        ...
        <div class="content">
            ...
            <div class="card-custom">
                <div class="card-header-custom">
                    ...
                    <div class="ch-title">Aprendices Asignados</div>
                </div>
                    ...
                    <asp:GridView ID="gvAprendices" runat="server"
                        ...
                        <EmptyDataTemplate>
                            <div class="empty-state">
                                ...
                                <p>No hay aprendices en tus fichas.</p>
                            </div>
                        </EmptyDataTemplate>
