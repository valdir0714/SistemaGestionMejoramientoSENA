...
<head runat="server">
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nav-link:hover { background: var(--green-soft); color: var(--green); }
        .nav-link.active { background: var(--green-soft); color: var(--green); font-weight: 600; }
        ...
        .alert-err {
            padding: 10px 14px; border-radius: 8px;
            background: #fff1f2; border: 1px solid #fecdd3;
            color: #9f1239; font-size: 13px; margin-bottom: 16px;
            display: flex; align-items: center; gap: 8px;
        }
        ...
        .table-custom tbody td { padding: 11px 14px; color: var(--text); vertical-align: middle; }
        .table-custom tbody td .code {
...
<div class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="Programas.aspx" class="nav-link active"><i class="fa-solid fa-book-open"></i> Programas</a>
    ...
    <div class="topbar">
        <div class="topbar-left">
            ...
            <div>
                ...
                <div class="page-sub">Registra, consulta, modifica y elimina programas de formación</div>
            </div>
        </div>
    ...
    <div class="content">
        ...
        <div class="card-custom">
            <div class="card-header-custom">
                ...
                <div class="ch-title"><asp:Label ID="lblTituloFormulario" runat="server" Text="Nuevo Programa"/></div>
            </div>
            <div class="card-body-custom">
                <asp:HiddenField ID="hfIdPrograma" runat="server" Value="0"/>
                <div class="row g-3 mb-3">
                    <div class="col-md-4">
                        <label class="form-label-custom">Código del Programa</label>
                        <asp:TextBox ID="txtCodigo" runat="server" CssClass="form-control-custom" placeholder="Ej: 228106"/>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label-custom">Nombre del Programa</label>
                    ...
                    <div class="col-md-4">
                        ...
                        <asp:TextBox ID="txtVersion" runat="server" CssClass="form-control-custom" placeholder="Ej: 102"/>
                    </div>
                </div>
                <div class="row g-3 mb-4">
                    <div class="col-md-4">
                        <label class="form-label-custom">Nivel de Formación</label>
                        <asp:DropDownList ID="ddlNivel" runat="server" CssClass="form-select-custom">
                    ...
                    <div class="col-md-4">
                        ...
                        <asp:TextBox ID="txtDuracion" runat="server" CssClass="form-control-custom" placeholder="Ej: 2200"/>
                    </div>
                    <div class="col-md-4">
        ...
        <div class="card-custom">
            <div class="card-header-custom" style="justify-content:space-between;">
                <div style="display:flex;align-items:center;gap:8px;">
                    ...
                    <div class="ch-title">Programas Registrados</div>
                </div>
                <div class="search-wrap">
                    <i class="fa-solid fa-magnifying-glass"></i>
                    <asp:TextBox ID="txtBuscar" runat="server" CssClass="search-input" placeholder="Buscar por nombre o código..." AutoPostBack="true" OnTextChanged="txtBuscar_TextChanged"/>
                </div>
            </div>
            <div class="card-body-custom" style="padding:0 0 4px 0;">
                    ...
                    <asp:GridView ID="gvProgramas" runat="server"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Código">
                                <ItemTemplate><span class="code"><%# Eval("CodigoPrograma") %></span></ItemTemplate>
                            </asp:TemplateField>
