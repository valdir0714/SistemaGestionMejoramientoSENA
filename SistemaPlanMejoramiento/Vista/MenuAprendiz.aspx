...
<head runat="server">
    ...
    <title>Menu Aprendiz - SENA</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .user-avatar { width: 36px; height: 36px; background: linear-gradient(135deg, #f59e0b, #d97706); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 14px; font-weight: 700; color: white; }
        ...
        .tarjeta { background: #111827; border: 1px solid #1f2937; border-radius: 16px; padding: 24px; transition: all 0.3s; text-decoration: none; display: block; }
    ...
    <form id="form1" runat="server">
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                <div class="menu-seccion">Mi Proceso</div>
                <a href="MiPerfil.aspx" class="menu-item">
                    <span class="menu-icono">👤</span> Mi Perfil
                </a>
                <a href="MiFicha.aspx" class="menu-item">
                    <span class="menu-icono">📋</span> Mi Ficha
                </a>
                <a href="MisResultados.aspx" class="menu-item">
                    <span class="menu-icono">📝</span> Mis Resultados
                </a>

                <div class="menu-seccion">Planes</div>
                <a href="MisPlanes.aspx" class="menu-item">
                    <span class="menu-icono">📌</span> Mis Planes
                </a>
                <a href="SubirEvidencias.aspx" class="menu-item">
                    <span class="menu-icono">📎</span> Subir Evidencias
                </a>
            </div>
        ...
        <div class="contenido">
            <div class="bienvenida">
                <h1>Mi Panel</h1>
                <p>Consulta tus planes de mejoramiento y sube tus evidencias</p>
            </div>

            <div class="tarjetas">
                <a href="MiPerfil.aspx" class="tarjeta">
                    <div class="tarjeta-icono azul">👤</div>
                    <h3>Mi Perfil</h3>
                    <p>Ver mis datos personales</p>
                </a>
                <a href="MiFicha.aspx" class="tarjeta">
                    <div class="tarjeta-icono verde">📋</div>
                    <h3>Mi Ficha</h3>
                    <p>Consultar mi ficha de formación</p>
                </a>
                <a href="MisPlanes.aspx" class="tarjeta">
                    <div class="tarjeta-icono morado">📌</div>
                    <h3>Mis Planes</h3>
                    <p>Consultar planes asignados</p>
                </a>
                <a href="SubirEvidencias.aspx" class="tarjeta">
                    <div class="tarjeta-icono naranja">📎</div>
                    <h3>Evidencias</h3>
                    <p>Subir evidencias de mis planes</p>
                </a>
            </div>
        </div>
    </form>
